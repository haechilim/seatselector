...
public class MyArrayTest {
    ...
    public void add() {
        ...
        assertThat(myArray.getCount(), is(15));
    }
    ...
    public void insert() {
        ...
        assertThat(myArray.get(4), is(6));
        assertThat(myArray.get(5), is(5));
        assertThat(myArray.get(6), is(40));
        assertThat(myArray.get(7), is(9));
        assertThat(myArray.get(8), is(8));
        assertThat(myArray.get(9), is(7));
        assertThat(myArray.get(10), is(10));

        assertThat(myArray.getCount(), is(11));
    }
    ...
    public void remove() {
        ...
        myArray.add(7);
        myArray.add(10);
        assertThat(myArray.getCount(), is(10));

        myArray.remove(777);
        assertThat(myArray.getCount(), is(10));

        myArray.remove(9);
        assertThat(myArray.getCount(), is(9));
        assertThat(myArray.get(0), is(2));
        assertThat(myArray.get(1), is(1));
        assertThat(myArray.get(2), is(3));
        assertThat(myArray.get(3), is(4));
        ...
        myArray.remove(6);
        assertThat(myArray.getCount(), is(8));
        assertThat(myArray.get(0), is(2));
        assertThat(myArray.get(1), is(1));
        assertThat(myArray.get(2), is(3));
        assertThat(myArray.get(3), is(4));
    ...
    public void count() {
        ...
        assertThat(myArray.getCount(), is(0));

        myArray.add(2);
        assertThat(myArray.getCount(), is(1));

        myArray.add(1);
        assertThat(myArray.getCount(), is(2));

        myArray.add(15);
        assertThat(myArray.getCount(), is(3));
